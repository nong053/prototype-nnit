...
if($action1=="add"){
	...
	if($name_myvdo==""){//check ค่าว่าง
				...
				/*header('location:index.php?page=vdo_system&select_page=myvdo&id_catmyvdo=$id_catmyvdo');*/
			...
			if($name_pic==""){
				...
				/*echo"<script>window.location=\"index.php?page=myvdo&id_catmyvdo=$id_catmyvdo\";</script>";*/
				echo"<script>window.location=\"index.php?page=vdo_system&select_page=myvdo&id_catmyvdo=$id_catmyvdo\";</script>";
				exit();
			...
			
			{
				...
				/*echo"<script>window.location=\"index.php?page=myvdo&id_catmyvdo=$id_catmyvdo&id_catmyvdo=$id_catmyvdo\";</script>";*/
				echo"<script>window.location=\"index.php?page=vdo_system&select_page=myvdo&id_catmyvdo=$id_catmyvdo\";</script>";
				exit();
			}
...
/* catลบรูปภาพ*/
	...
	echo"error".mysql_error();
		...
		/*echo"<script>window.location=\"index.php?page=myvdo&id_catmyvdo=$id_catmyvdo2\";</script>";*/
