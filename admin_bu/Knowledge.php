...
<table border="0" cellpadding="0" cellspacing="0" width="770">
        ...
        <tr>
            ...
            <input type="text" name="Knowledge_title" value="<?=$Knowledge_title_edit?>" />ลิงค์ไปเว็บอื่นๆตัวอย่างเช่น http://www.google.com
            <input type="text" name="Knowledge_link" value="<?=$Knowledge_link_edit?>" style="color:#999; width:200px; background-color:#FFC;"  />
