...
$main_menu_type=$_POST['main_menu_type'];
...
$strSQL="insert into main_menu(main_menu_name,main_menu_detail,main_menu_link,main_menu_type)values('$main_menu_name','$main_menu_detail','$main_menu_link','$main_menu_type')";
...
$strSQL="update main_menu set main_menu_name='$main_menu_name',main_menu_detail='$main_menu_detail',main_menu_link='$main_menu_link',main_menu_type='$main_menu_type' where main_menu_id='$main_menu_id'";
$result=mysql_query($strSQL);
