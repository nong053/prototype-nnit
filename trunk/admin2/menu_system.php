...
function doajax(mydata){
	...
	ajax1.send("menu_name="+document.form1.menu_name.value+"&menu_link="+document.form1.menu_link.value+"&menu_detail="+document.form1.menu_detail.value+"&action_menu="+document.form1.action_menu.value+"&main_menu_id="+document.form1.main_menu_id.value);
	}
}
...
<table border="0" cellpadding="0" cellspacing="0" width="770">
        ...
        <tr>
            ...
            <input type="text" name="menu_name" value="<?=$main_menu_name_edit?>" />ลิงค์ไปเว็บอื่นๆตัวอย่างเช่น http://www.google.com
...
<!--CKEditor-->
    ...
    <textarea cols="100%" id="menu_detail" name="menu_detail" rows="10" ><?=$main_menu_detail_edit?></textarea>
