...
$strSQL="insert into main_menu(main_menu_name,main_menu_detail,main_menu_link)values('$main_menu_name','$main_menu_detail','$main_menu_link')";
...
$strSQL="update main_menu set main_menu_name='$main_menu_name',main_menu_detail='$main_menu_detail',main_menu_link='$main_menu_link' where main_menu_id='$main_menu_id'";
$result=mysql_query($strSQL);
