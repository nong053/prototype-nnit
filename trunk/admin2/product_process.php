<?php 
	...
	if ($action == "edit"){
		...
		$sql="UPDATE product SET product_name='$product_name', product_detail='$product_detail',product_price='$product_price',product_promotion='$product_promotion',product_amount='$product_amount' WHERE product_id='$product_id'";
		...
		$sql="INSERT INTO product (productcat_id, product_name, product_detail,product_price, product_promotion,product_amount,product_date) VALUES ('$productcat_id', '$product_name', '$product_detail','$product_price','$product_promotion','$product_amount',now())";
		mysql_query($sql)or die (mysql_error());
