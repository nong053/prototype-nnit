<?php 
	...
	if ($action == "edit"){
		...
		$sql="UPDATE picture SET picture_detail='$picture_detail',picture_important='$picture_important',picture_date='$picture_date' WHERE picture_id='$picture_id'";
		...
		$sql="INSERT INTO picture (picturecat_id, picture_detail,picture_important,picture_date) VALUES ('$picturecat_id','$picture_detail','$picture_important','$picture_date')";
		mysql_query($sql)or die (mysql_error());
