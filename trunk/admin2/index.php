...
<div id="header">
	...
	<div id="header-r">
		ยินดีต้อนรับ, <img src="images/details.gif" width="16" height="16" border="0" align="absbottom" /> <strong><?=$_SESSION['admin_name']?> <?=$_SESSION['admin_surname']?></strong> <img src="images/logout.gif" width="16" height="16" border="0" align="absbottom" /> <a href="index.php?logout">ออกจากระบบ</a>	</div>
	<br style="clear:both;" />
</div>
<br style="clear:both;" />
<div id="main">
                 ...
                 <li><a href="index.php?page=tour"><img  src="images/announcement.gif" width="16" height="16" border="0" align="absbottom" /> ทัวร์ท่องเที่ยว</a></li>
                  ...
                  <li><a href="index.php?page=ecommerce_system"><img src="images/iPod_alt.png" border="0" align="absbottom" /> ร้านค้าออนไลน์</a></li>
                   ...
                   <li><a href="index.php?page=mlm_system"><img src="iFile.png" border="0" align="absbottom" /> ธุรกิจเครื่อข่าย</a></li>
                	 ...
                	 <li><a href="index.php?page=ecommerce_system"><img src="images/Phone.png" border="0" align="absbottom" /> ระบบจองโรงแรม</a></li>
                     ...
                     <li><a href="index.php?page=ecommerce_system"><img src="images/Photos.png" border="0" align="absbottom" /> ระบบตกแต่งเว็บ</a></li>
                     
                     <li><a href="index.php?page=ecommerce_system"><img src="images/pic_small/YouTube.png" border="0" align="absbottom" /> ระบบทีวีออนไลน์</a></li>
                     
                     <li><a href="index.php?page=ecommerce_system"><img src="images/pic_small/iPod.png" border="0" align="absbottom" /> ระบบวิทยุออนไลน์</a></li>
                     
                      <li><a href="index.php?page=ecommerce_system"><img src="images/pic_small/Things.png" border="0" align="absbottom" /> ระบบโปรโมทเว็บ(SEO)</a></li>
                      
                       <li><a href="index.php?page=ecommerce_system"><img src="images/pic_small/Settings.png" border="0" align="absbottom" /> สมัครงาน</a></li>
