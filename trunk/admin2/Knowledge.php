...
<table border="0" cellpadding="0" cellspacing="0" width="770">
        ...
        <tr>
            ...
            <input type="text" title="Knowledge_title" value="<?=$Knowledge_title_edit?>" />ลิงค์ไปเว็บอื่นๆตัวอย่างเช่น http://www.google.com
            <input type="text" title="Knowledge_link" value="http://www.<?=$Knowledge_link_edit?>" style="color:#999; width:200px; background-color:#FFC;"  />
...
<!--CKEditor-->
    <textarea cols="100%" id="Knowledge_detail" title="Knowledge_detail" rows="10" ><?=$Knowledge_detail_edit?></textarea>
    ...
    <!--CKEditor-->
            ...
            <tr>
                ...
                <td>
                <input type="hidden" value="<?=$action_Knowledge?>" title="action_Knowledge" />
                <input type="hidden" value="<?=$Knowledge_id?>"  title="Knowledge_id"/>
