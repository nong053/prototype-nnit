...
<div class="bg_admin">
	<div id="box_admin">
		...
		switch($select_page){
			case'select_style' :$select1="select";break;
			case'picture_style':$select2="select";break;
			case'preview_style' :$select3="select";break;
			
			default:$select1="select";break;
		}
		?>
        ...
        <div id="bg_bt">
         	...
         	<ul>
            		<li>
                     ...
                     <li>
                		<div id="<?=$select2?>">
              		 		<a href="index.php?page=style_system&select_page=picture_style">
                            <div id="devmagin" style="margin:5px;">
              			 	จัดการรูปภาพ
                     		</div>
              			 	</a>
                    ...
                    <li>
                		<div id="<?=$select3?>">
              		 		<a href="index.php?page=style_system&select_page=preview_style">
                            <div id="devmagin" style="margin:5px;">
              			 	ตรวจสอบ
                     		</div>
              			 	</a>
		...
		switch($select_page){
			case'select_style':include("select_style.php");break;
			case'picture_style':include("picture_style.php");break;
			case'preview_style':include("preview_style.php");break;
		
			default:include("select_style.php");break;
		}
		?>
            </div>
        </div>
