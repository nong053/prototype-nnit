...
if(!$result){
	...
	/*echo"<script>window.location=\"index.php?page=catmyvdo\";</script>";*/
	header('location:index.php?page=vdo_system&select_page=catmyvdo');
	...
	if($num){
		echo"<script>alert(\"ชื่อหมวดวีดีโอซ้ำครับ\");</script>";
		/*echo"<script>window.location=\"index.php?page=vdo_system&select_page=catmyvdo\";</script>";*/
		header('location:index.php?page=vdo_system&select_page=catmyvdo');
		}else{
