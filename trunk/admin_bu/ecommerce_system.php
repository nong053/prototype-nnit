...
<div class="bg_admin">
	<div id="box_admin">
		...
		switch($select_ecommerce){
			...
			case'product_check_order' :$select5="select";break;
		...
		switch($select_ecommerce){
			...
			case'product_payment_check':include("product_payment_check.php");break;
			case'product_check_order':include("product_check_order.php");break;
			
			default:include("productcat.php");
			break;
		}
		?>
            </div>
