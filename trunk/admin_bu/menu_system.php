...
<div class="bg_admin">
	<div id="box_admin">
		...
		switch($select_page){
			case'main_menucat' :$select1="select";break;
			case'main_menu' :$select2="select";break;
        ...
        <div id="bg_bt">
         	...
         	<ul>
            		<li>
                		<div id="<?=$select1?>">
              		 		<a href="index.php?page=menu_system&select_page=main_menucat">
		...
		switch($select_page){
			case'main_menucat':include("main_menucat.php");break;
			case'main_menu':include("main_menu.php");break;
			
			default:include("main_menucat.php");
			break;
		}
		?>
            </div>
