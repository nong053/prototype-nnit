			...
			?>
					...
					<div id="row5">
						...
						<div class="mainBox">
								...
								<!-- fadebook-->
									...
									?>
									<a href="index.php?page=news&news_id=<?=$rsNews[news_id]?>">
					...
					<div id="row6">
						<div id="column61">
							...
							<?php
								$bj_manage = new manage_data();
								$resultYoutube=$bj_manage->select_data("youtupe");
							...
							//ปิดจัดการรูปภาพ
								...
								?>
								<div class="divTvReBack">
								<a href="index.php?youtube_id=<?=$id_youtupe?>">
...
try {Histats.start(1,2033489,4,1041,200,30,"00011111");
Histats.track_hits();} catch(err){};
</script></a>
<noscript><a href="http://www.histats.com" target="_blank"><img  src="http://sstatic1.histats.com/0.gif?2033489&101" alt="counter free hit unique web" border="0"></a></noscript>
<!-- Histats.com  END  -->
</center>
