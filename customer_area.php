...
<div class="bg_admin">
	<div id="box_admin">
        ...
        <?
		$select_member=$_GET['select_member'];
		switch($select_member){
			case'member_add' :$select1="select";break;
			case'payment' :$select2="select";break;
			case'status_order' :$select3="select";break;
		...
		switch($select_member){
			case'member_add':include("member.php");break;
			case'payment':include("payment.php");break;
			case'status_order':include("status_order.php");break;
