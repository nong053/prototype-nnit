...
<table cellpadding="0" cellspacing="0" width="100%">
	...
	?>  		
                ...
                <a href="index.php?page=news_system&select_news=new_politics&news_id=<?=$rs[news_id]?>&action2=edit&select_news=new_politics&news_cat_id=<?=$rs[news_cat_id]?>">
                <img src="images/b_edit.png"  border="0"/>
        		แก้ไขข้อมูล
                </a>
                 <a onClick="return confirm('คุณต้องการลบข้อมูลนี้ ?');" href="news_process.php?actionget=del&news_id=<?=$rs[news_id]?>&news_cat_id=<?=$rs[news_cat_id]?>&select_news=new_politics">
...
<input type="hidden" name="select_page" value="new_politics" />
