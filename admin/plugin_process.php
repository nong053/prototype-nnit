...
//$db= new database();
if($action=="add"){
$strSQL="insert into plugin_on_web(plugin_name,plugin_code,plugin_status,plugin_position,admin_id)values('$plugin_name','$plugin_code','$plugin_status','$plugin_position','$admin_id')";
