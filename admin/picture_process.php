<?php 
	...
	if ($action == "edit"){
		...
		$sql="INSERT INTO picture (picturecat_id, picture_detail,picture_detail_eng,picture_important,picture_date) VALUES ('$picturecat_id','$picture_detail','$picture_detail_eng','$picture_important','$picture_date')";
		mysql_query($sql)or die (mysql_error());
