...
<div class="bg_admin">
	<div id="box_admin">
		...
		switch($select_page){
			case'catmyvdo' :$select1="select";break;
			case'myvdo':$select2="select";break;
			case'youtube_cat' :$select3="select";break;
			case'youtube':$select4="select";break;
		...
		switch($select_page){
			case'catmyvdo':include("catmyvdo.php");break;
